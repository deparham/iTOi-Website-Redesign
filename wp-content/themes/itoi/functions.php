...
require ITOI_THEME_DIR . '/inc/products.php';
require ITOI_THEME_DIR . '/inc/product-carousel.php';
...
require ITOI_THEME_DIR . '/inc/partners.php';
require ITOI_THEME_DIR . '/inc/trust.php';
